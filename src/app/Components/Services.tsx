...
export function Services() {
    ...
    return (
        <section className="py-24 bg-background relative overflow-hidden min-h-[800px] flex flex-col items-center" id="services">
            ...
            <div className="container mx-auto px-6 relative z-10 flex flex-col items-center">
                ...
                <motion.div
                    className="relative w-full max-w-[1200px] h-[400px] flex items-center justify-center cursor-pointer perspective-1000 py-10"
                                ...
                                variants={{
                                    hover: {
                                        ...
                                        transition: {
                                            ...
                                            repeat: Infinity,
                                            ease: "easeInOut",
                                            delay: index * 0.2, // Increased stagger for better flow
                                        }
                                    }
                                }}
                                transition={{
